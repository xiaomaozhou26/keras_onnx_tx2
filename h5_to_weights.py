...
def parser():
    ...
    parser.add_argument('-cfg_path', default='models/sss.cfg')
    parser.add_argument('-weights_path', default='models/sss.h5')
    parser.add_argument('-output_path', default='models/sss.weights')
